...
// PIP Swap Logic
document.getElementById('local-video').onclick = (e) => {
  e.stopPropagation(); // Don't trigger fullscreen when clicking PIP
  const localVideo = document.getElementById('local-video');
  const remoteVideo = document.getElementById('remote-video');
...
document.getElementById('fullscreen-call-btn').onclick = (e) => {
  e.stopPropagation();
  window.toggleCallFullscreen();
};
